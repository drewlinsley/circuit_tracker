...
def run_all_videos(tracker_name, tracker_param, videofile, detections, output_dir, optional_box=None, debug=None, save_results=False):
    ...
    for f in tqdm(files, total=len(files), desc="Processing video"):
        run_video(tracker, tracker_param, f, csv, output_dir, optional_box=None, debug=None, save_results=False)


def run_video(tracker, tracker_param, videofile, csv, output_dir, optional_box=None, debug=None, save_results=False):
...
def main():
    ...
    run_all_videos(args.tracker_name, args.tracker_param, args.videofile, args.detections, args.output_dir, args.optional_box, args.debug, args.save_results)
