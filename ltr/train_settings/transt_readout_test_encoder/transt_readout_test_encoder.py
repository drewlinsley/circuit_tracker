...
import ltr.models.tracking.transt_circuit_encoder_test_v1 as transt_models
...
def run(settings):
    ...
    dataset_train = sampler.TransTSampler([lasot_train, got10k_train, trackingnet_train], [1, 1, 1], samples_per_epoch=1000*settings.batch_size, max_gap=settings.sequence_length * 4, processing=data_processing_train, num_search_frames=settings.sequence_length, frame_sample_mode="rnn_interval")
