...
class TransT(nn.Module):
    ...
    def __init__(self, backbone, featurefusion_network, num_classes, input_dim=32, rnn_dims=64, timesteps=32):
        ...
        self.bn = nn.GroupNorm(4, self.rnn_dims, affine=False)  # nn.BatchNorm2d(self.rnn_dims, eps=1e-03, affine=False, track_running_stats=True)
...
def transt_loss(settings):
    ...
    weight_dict['loss_giou_circuit'] = 2
    losses = ['labels', 'boxes']
